...
export const CodeOfConductSection = () => {
  return (
    <section id="code-of-conduct" className="py-16 bg-black">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="sr-heading text-6xl font-black text-white mb-4">
            Code of Conduct
          </h2>
        </div>

        <div className="sr-content bg-gray-900 rounded-lg shadow-sm p-8">
          ...
          <div className="sr-card bg-purple-900/30 border-l-4 border-purple-400 p-6 mb-8">
            <h3 className="text-2xl font-black text-purple-300 mb-3">
              Contact Information
            </h3>
